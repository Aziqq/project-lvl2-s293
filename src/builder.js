...
const bothHasProp = (obj1, obj2, key) => _.has(obj1, key) && _.has(obj2, key);
const firstHasProp = (obj1, obj2, key) => _.has(obj1, key) && !_.has(obj2, key);
...
const propertyActions = [
  ...
  {
    check: (obj1, obj2, key) => firstHasProp(obj1, obj2, key),
    process: property1 => ({ value: property1 }),
    type: 'removed',
  },
  {
    check: (obj1, obj2, key) => firstHasProp(obj2, obj1, key),
